...
// NEW: Check local storage for the user's saved preference. Default to true if they've never clicked it.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // NEW GLOBAL COLLAPSE BUTTON LOGIC WITH LOCAL STORAGE
    const toggleAllBtn = document.getElementById('toggle-all-lineups');
    if (toggleAllBtn) {
        // Set the initial text of the button based on our saved state
